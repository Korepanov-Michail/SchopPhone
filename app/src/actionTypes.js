...
export const FETCH_MORE_PHONES_START = 'FETCH_MORE_PHONES_START'
export const FETCH_MORE_PHONES_SUCCESS = 'FETCH_MORE_PHONES_SUCCESS'
export const FETCH_MORE_PHONES_FAILURE = 'FETCH_MORE_PHONES_FAILURE'
